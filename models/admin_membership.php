 ...
 */
class JomdirectoryModelAdmin_membership extends JModelList
{
	/**
	...
	public function getPlan()
	{
		...
		$query = "SELECT group_id FROM #__cddir_plans WHERE extension='com_jomdirectory' ORDER BY price_annually desc, price_monthly desc, id desc";
		...
		if (!isset($row->group_id)) return false;
		return $row->group_id;
	}
