 ...
 */
class JomdirectoryModelAddImage extends JModelAdmin
{
	/**
	 ...
	 * @since    1.6
	 */
	public function getTable($name = 'Image', $prefix = 'JomdirectoryTable', $config = array('ignore_request' => true))
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_jomdirectory.image', 'addimage', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
...
//            $data = JFactory::getApplication()->getUserState('com_jomdirectory.edit.article.data', array());
		...
		if (!$data->content_id) $data->content_id = JRequest::getInt('content_id');
