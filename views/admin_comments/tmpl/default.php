...
?>
<div id="jd-admin-wrapper" class="jomdirectory reviews">

	<?php echo $header->render(null); ?>

    <div class="border-bottom mt-3 clearfix">
        <div class="float-left">
            <h3><?php echo JText::_('COM_JOMDIRECTORY_ADM_REVIEWS') ?></h3>
        </div>
    ...
    <div id="admin-header" class="my-3 pb-3 border-bottom">
        <form name="jdFormItems" action="" method="post">
            <div class="clearfix form-row align-items-center">
				...
				<?php
				$arraySort = array(array('v' => 'latest', 't' => JText::_('COM_JOMDIRECTORY_HEADER_SORT_LATEST')), array('v' => 'alfa', 't' => JText::_('COM_JOMDIRECTORY_HEADER_SORT_ALPHABETICALLY')), array('v' => 'rated_desc', 't' => JText::_('COM_JOMDIRECTORY_HEADER_SORT_RATED_DESC')), array('v' => 'rated_asc', 't' => JText::_('COM_JOMDIRECTORY_HEADER_SORT_RATED_ASC')));
				?>
                <div class="d-inline">
				...
				foreach ($this->reviews as $row): ?>
                    <tr>
                        <td>
							...
							<?php echo JHtml::_('jgrid.published', $row->approved, $i, 'admin_comments.', 1); ?>
                        </td>
                        <td>
                        ...
                        <td>
							<?php echo $row->name ?> <?php echo $row->username ?><br/> <span class="text-muted"><?php echo $row->date_modified ?></span>
                        </td>
                    </tr>
					<?php $i++; endforeach; ?>
                </tbody>
