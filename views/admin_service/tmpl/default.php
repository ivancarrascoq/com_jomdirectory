...
<script type="text/javascript">
	Joomla.submitbutton = function (task) {
		if (task == 'admin_service.cancel' || document.formvalidator.isValid(document.id('item-form'))) {
...
<div id="jomdirectory-admin">
	...
	<?php if ($this->blocked): ?>
        <div class="text-center my-5">
			<?php echo "<div class='alert alert-danger'>" . JText::_('COM_JOMDIRECTORY_ADM_PLAN_BLOCKED') . "</div>"; ?>
        </div>
	<?php else: ?>
        ...
        <div id="admin-body" class="card card-body my-3">
            ...
            <form action="<?php echo JRoute::_('?option=com_jomdirectory&layout=edit&id=' . (int)$this->item->id); ?>" enctype="multipart/form-data" method="post" name="adminForm" id="item-form" class="form-validate ">
                <div class="jd-admin-box">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
	                        <?php echo $this->form->getLabel('day_of_week'); ?>
	                        <?php echo $this->form->getInput('day_of_week'); ?>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="border-top mt-3 pt-3 clearfix">
                <div class="float-right">
					<?php echo $this->toolbar ?>
                </div>
            </div>
