...
<div id="jomdirectory-admin" class="jomdirectory membership">
                        ...
                        <div class="col-md-5 col-lg-4">
                            <div class="item">
								<?php if ($row->best_value): ?>
                                    <div class="ribbon"><?php echo JText::_('COM_JOMDIRECTORY_ADM_MEMBERSHIP_BESTVALUE') ?></div><?php endif ?>
                                <div class="heading">
                                ...
                                <div class="features">
									...
									<?php if ($this->params->get('product_display')): ?>
                                        <h4>
                                            <span class="feature">  <?php echo JText::_('COM_JOMDIRECTORY_PRODUCTS') ?></span> : <span class="value">
	                                            <?php if (!isset($row->paid_fields['products']) || $row->paid_fields['products'] == 0): echo "<i class='fa fa-times></i> ";
                                    ...
                                    <h4>
                                        <span class="feature"><?php echo JText::_('COM_JOMDIRECTORY_FIELD_PHONE') ?></span> : <span class="value">
                                            <?php if ($row->paid_fields['phone'] == 1): echo "<i class='fa fa-times'></i> ";
                                            else: echo "<i class='fa fa-check'></i>"; endif; ?>
                                        </span>
                                    </h4>
                                    <h4>
                                        <span class="feature"><?php echo JText::_('COM_JOMDIRECTORY_FIELD_WEBPAGE') ?></span> : <span class="value">
                                            <?php if ($row->paid_fields['webpage'] == 1): echo "<i class='fa fa-times'></i> ";
                                            else: echo "<i class='fa fa-check'></i>"; endif; ?>
                                        </span>
                                    </h4>
                                ...
                                <div class="text-center">
									<?php if ($payments && $buy): ?>
                                        <a href="<?php echo JURI::root() ?>index.php?option=com_jomdirectory&view=admin_membership_buy&plan_id=<?php echo $row->id ?>" class="btn btn-lg <?php if ($row->best_value): ?>btn-primary <?php else: ?> btn-outline-primary <?php endif; ?>">
                                            <i class="fa fa-arrow-circle-up"></i> <?php echo JText::_('COM_JOMDIRECTORY_ADM_MEMBERSHIP_UPGRADE') ?>
                                        </a>
									<?php elseif ($buy): ?>
                                        <span class="btn btn-danger btn-lg disabled"> <?php echo JText::_('COM_JOMCOMDEV_NO_PAYMENT_METHOD') ?></span>
									<?php endif; ?>
									<?php if ($this->plan == $row->group_id): ?>
                                        <span class="btn btn-outline-success btn-lg disabled"><?php echo JText::_('COM_JOMDIRECTORY_ADM_MEMBERSHIP_CURRENT') ?></span>
										<?php $buy = 1; endif; ?>
                                </div>
                            </div>
                        </div>
