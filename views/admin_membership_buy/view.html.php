 ...
 */
class JomdirectoryViewAdmin_membership_buy extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		if ($layout == 'success') {
			$this->article = $this->get('SuccessArticle');
			$this->response = $this->get('PaymentResponse');
		} else if ($layout == 'review') {
			$this->newplan = $this->get('New_plan');
			$this->plan = $this->get('Plan');
			$this->sendPayment = $this->get('SendPayment');
		} else {
			$this->newplan = $this->get('New_plan');
			$this->plan = $this->get('Plan');
		}
