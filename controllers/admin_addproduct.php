 ...
 */
class JomdirectoryControllerAdmin_AddProduct extends JControllerForm
{
	/**
	 * Class constructor.
	 *
	...
	{
		JRequest::setVar('view', 'admin_addproduct');
		$this->view_list = 'admin_products';
		$this->view_item = 'admin_addproduct';
