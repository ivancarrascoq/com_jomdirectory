 ...
 */
class JomdirectoryControllerAdmin_booking extends JControllerForm
{
	/**
	 * Class constructor.
	 *
	...
	{
		JRequest::setVar('view', 'admin_booking');
		$this->view_list = 'admin_bookings';
		$this->view_item = 'admin_booking';
